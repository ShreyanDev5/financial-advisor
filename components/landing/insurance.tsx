      ...
      <div className="container mx-auto space-y-6 sm:space-y-8 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center gap-2.5 sm:gap-3.5 mb-2 w-full">
          ...
          <div className="relative w-full max-w-xl mx-auto overflow-hidden z-20">
            ...
            >
              <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-white/60 backdrop-blur-md shadow-sm border border-white/50 ring-1 ring-black/[0.04]"><ChevronLeft className="flex-shrink-0 w-3.5 h-3.5 -translate-x-[0.5px] text-blue-600 animate-pulse-slow" /></span>
            </button>
            ...
            >
              <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-white/60 backdrop-blur-md shadow-sm border border-white/50 ring-1 ring-black/[0.04]"><ChevronRight className="flex-shrink-0 w-3.5 h-3.5 translate-x-[0.5px] text-blue-600 animate-pulse-slow" /></span>
            </button>
