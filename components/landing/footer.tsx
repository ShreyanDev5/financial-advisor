...
export default function Footer() {
  ...
  const getTabColors = useCallback((colorScheme: 'emerald' | 'blue' | 'orange' | 'purple' | 'teal', isActive: boolean) => {
    const colors = {
      emerald: {
        bg: isActive ? "bg-emerald-50" : "",
        button: isActive ? "bg-emerald-500 text-white" : "text-gray-400",
        text: isActive ? "text-emerald-600" : "text-gray-400",
      },
      blue: {
        bg: isActive ? "bg-blue-50" : "",
        button: isActive ? "bg-blue-500 text-white" : "text-gray-400",
        text: isActive ? "text-blue-600" : "text-gray-400",
      },
      orange: {
        bg: isActive ? "bg-orange-50" : "",
        button: isActive ? "bg-orange-500 text-white" : "text-gray-400",
        text: isActive ? "text-orange-600" : "text-gray-400",
      },
      teal: {
        bg: isActive ? "bg-teal-50" : "",
        button: isActive ? "bg-teal-500 text-white" : "text-gray-400",
        text: isActive ? "text-teal-600" : "text-gray-400",
      },
      purple: {
        bg: isActive ? "bg-purple-50" : "",
        button: isActive ? "bg-purple-500 text-white" : "text-gray-400",
